...
#define KEYMAP( \
    ...
    { KB_NO,    KB_##K96, KB_NO,    KB_##K97, KB_NO,    KB_NO,    KB_NO,    KB_##KA7 }, \
    { KB_NO,    KB_NO,    KB_NO,    KB_NO,    KB_NO,    KB_NO,    KB_NO,    KB_##KAF }, \
    { KB_NO,    KB_NO,    KB_##K95, KB_NO,    KB_NO,    KB_NO,    KB_NO,    KB_##KB7 }, \
...
static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
    ESC, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12,           PSCR,SLCK,BRK,          F13, PWR, F14,
